  ...
  return (
    <>
      <div className="flex justify-between gap-[10px] mt-[24px] py-[32px] px-[8px]">
        <div className="relative border-[2px] border-[#1d1d1d] rounded-[20px] bg-[#fff] p-[8px] w-[170px] rotate-[-3deg] card-list">
        ...
        <div className="relative border-[2px] border-[#1d1d1d] rounded-[20px] bg-[#fff] p-[8px] w-[170px] rotate-[5deg] top-[20px]">
        ...
        <div className="w-[100%]">
          <div className="relative flex flex-row items-center border-[2px] border-[#1d1d1d] rounded-[20px] p-[16px]">
            <div className="absolute w-[12px] h-[12px] bg-black rounded-full z-1 top-[10px] left-[10px]">
              ...
              <div className="relative w-[6px] bg-white border-[1px] rounded-[99em] h-[50px] left-[-37px] top-[-37px]"></div>
            </div>
